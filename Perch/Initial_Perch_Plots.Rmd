...
```
<br>Note the extremely high CPUE for RS in 2016. NRL actually was on the crew that pulled a fyke net with estimated 11k RS. The fyke at over 2kg of RS (approx weight of yoy RS 0.2g). Note that the y-axis is log10 scaled.
...
\newpage
```{r o2temp, echo=FALSE,cache=TRUE}
o2temp = read.csv("https://lter.limnology.wisc.edu/file/12809/download?token=JYdz8XZAHxsISPBLENdIuoQ5ma171D4B_Vd4WgpWCYQ")
